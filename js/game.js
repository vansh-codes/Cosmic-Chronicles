document.addEventListener("DOMContentLoaded", function() {
    ...
    explosionSound.src = "./images/explode.mp3";
    ...
    //     interfaceDiv.style.display = "none";
    //     gameContainer.style.display = "block";
    //     gameInterval = setInterval(createAsteroid, 1200);
    //     resumeBtn.style.display = "none"; // Hide the resume button after resuming game
    // }
    ...
    function createAsteroid() {
        ...
        asteroid.style.backgroundImage = `url('/images/asteroid-${size}.png')`; // Use different asteroid images
    ...
    function asteroidClicked(asteroid) {
        // score += parseInt(asteroid.getAttribute("size")) * 10; // Increase score based on size
    ...
    function updateHealthBar() {
        ...
        earth.style.backgroundImage = "url('/images/earth.png')";
        /* else if(health <= 100 && health > 70){
            earth.style.backgroundImage = "url('/images/earth.png')";
        }
        else if (health <= 70 && health > 40) {
            earth.style.backgroundImage = "url('/images/earth-damaged.jpeg')"; // Change Earth image when health is below 70%
        } else if (health <= 40 && health > 10) {
            earth.style.backgroundImage = "url('/images/earth-dest.png')"; // Change Earth image when health is below 40%
        }
        else if (health <= 10) {
            earth.style.backgroundImage = "url('/images/earth-boom.jpeg')"; // Change Earth image when health is below 10%
        } */
    }
});